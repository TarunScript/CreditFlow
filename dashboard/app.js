...
function renderBorrowerDossier() {
  ...
  container.innerHTML = `
    ...
    <div class="subtab-row">
      ...
      <button class="subtab-btn ${state.dossierSubTab === 'scenarios' ? 'active' : ''}" onclick="setDossierSubTab('scenarios')">⚖️ Multi-Strategy Scenarios (5 Plans)</button>
      ...
      <button class="subtab-btn ${state.dossierSubTab === 'calendar' ? 'active' : ''}" onclick="setDossierSubTab('calendar')">🗓️ Monthly Cash-Flow Calendar</button>
    </div>
