...
with nav_bar_col1:
 ...
 <img src="{LOGO_DATA_URI}" alt="CreditFlow" style="height:36px; width:auto; object-fit:contain;" />
...
with nav_bar_col3:
 ...
 theme_icon = " Dark" if not is_dark else " Light"
...
PAGE_MAP = {
 ...
 " Predictor Studio": "Underwriting Predictor Studio",
...
if data_source == " Executive Overview (Landing Page)":
 ...
 st.write("")
 st.markdown("### The Core Dilemma: Rigid EMIs vs. Adaptive Credit")
...
<div class="terminal-header">
 ...
 <img src="{LOGO_DATA_URI}" alt="CreditFlow" style="height:40px; width:auto; object-fit:contain;" />
 <div>
