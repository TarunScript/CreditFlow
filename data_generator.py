...
def _build_all_borrowers():
    ...
    _add_borrower("B01", "Meenakshi S. - Textile & Tailoring Works", "stable", income, expenses,
    ...
    _add_borrower("B02", "Balwinder S. - Wheat & Mustard Farm", "seasonal", income, expenses,
    ...
    _add_borrower("B03", "Aakash V. - Logistics & Delivery Partner", "gig", income, expenses,
    ...
    _add_borrower("B04", "Ganesh K. - Commercial Fleet Operator", "temporary_shock", income, expenses,
    ...
    _add_borrower("B05", "Rajeshwar G. - General Provision Store", "structural_decline", income, expenses,
    ...
    _add_borrower("B06", "Radhika I. - Artisanal Cloud Kitchen", "growing", income, expenses,
    ...
    _add_borrower("B07", "Mohammad I. - Fresh Fruits Merchant", "chronic_strain", income, expenses,
    ...
    _add_borrower("B08", "Kavita D. - Dairy & Confectionery Startup", "recovering", income, expenses,
